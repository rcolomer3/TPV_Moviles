CREATE DATABASE  IF NOT EXISTS `gestionbbdd` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gestionbbdd`;
-- MySQL dump 10.13  Distrib 5.6.23, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: gestionbbdd
-- ------------------------------------------------------
...
--
-- Table structure for table `empleadosfijos`
--

DROP TABLE IF EXISTS `empleadosfijos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `empleadosfijos` (
  ...
  `fechaContrac` varchar(50) NOT NULL DEFAULT '00-00-0000',
  ...
  `SueldoFijo` float DEFAULT '0',
  `SueldoHoras` float DEFAULT '0',
  PRIMARY KEY (`DNI`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `empleadosfijos`
--

LOCK TABLES `empleadosfijos` WRITE;
/*!40000 ALTER TABLE `empleadosfijos` DISABLE KEYS */;
INSERT INTO `empleadosfijos` VALUES ('Miguel','Gandiaa','04677781H',26,'699586369','12-11-1988','19-10-2010','miguel','81dc9bdb52d04dc20036dbd8313ed055','miguel@gmail.com',1,'user','src/TPV/Img/empleado.png',4,900,600),('Juanito','Antonio','16200730J',32,'633256996','30-5-1982','18-5-2008','AE29I','81dc9bdb52d04dc20036dbd8313ed055','rcolomer3@gmail.com',0,'Administrador','src/TPV/Img/empleado.png',6,1300,800),('Lauri','Ramos','16426883F',35,'698563202','6-4-1980','7-4-2002','laurita','81dc9bdb52d04dc20036dbd8313ed055','laurara@gmail.com',0,'user','src/TPV/Img/empleado.png',13,1300,800),('Sergio','Lopez','23469776R',33,'698563001','13-8-1981','25-3-2009','sergio','81dc9bdb52d04dc20036dbd8313ed055','sergio@gmail.com',0,'user','src/TPV/Img/empleado.png',6,1300,800),('Jaume','Taure','25076823S',33,'698563025','16-9-1981','21-5-2011','jaume','81dc9bdb52d04dc20036dbd8313ed055','jaume@gmail.com',0,'user','src/TPV/Img/empleado.png',3,1300,600),('Maria','Martinez','28056545H',36,'695369853','24-10-1978','18-11-2012','maria','81dc9bdb52d04dc20036dbd8313ed055','maria@gmail.com',0,'user','src/TPV/Img/empleado.png',2,980,600),('Tomass','Marti','39192792X',30,'698563021','21-2-1985','16-7-2011','tomaas','81dc9bdb52d04dc20036dbd8313ed055','tomaas@gmail.com',0,'user','src/TPV/Img/empleado.png',3,1300,600),('Josete','Gramage','45855444E',33,'600256398','4-4-1982','11-4-2009','jose','81dc9bdb52d04dc20036dbd8313ed055','jose2@gmail.com',0,'user','src/TPV/Img/empleado.png',6,1300,800),('Raul','Colomer','48607190W',22,'665538067','14-3-1993','1-1-2011','raul','827ccb0eea8a706c4c34a16891f84e7b','raul@gmail.com',1,'Administrador','src/TPV/Img/FE8WNTINUZ.jpg',4,1300,600),('Jose Miguel','Hernandez','57379364E',34,'666999668','3-5-1981','16-5-2010','S8DAX','81dc9bdb52d04dc20036dbd8313ed055','rcolomer3@gmail.com',0,'Administrador','src/TPV/Img/empleado.png',4,1300,600),('Paulita','Sanz','71586317J',36,'669523021','22-4-1979','9-4-2011','paulasanz','81dc9bdb52d04dc20036dbd8313ed055','paulasanz@gmail.com',0,'user','src/TPV/Img/empleado.png',4,1300,600),('Lucia','Vidal','73484232Z',37,'659365201','12-11-1977','19-10-2007','lucia','81dc9bdb52d04dc20036dbd8313ed055','lucia@gmail.com',0,'user','src/TPV/Img/empleado.png',7,900,600),('Damina','Donate','78347191Z',38,'655896325','1-5-1977','19-5-2001','YO74V','41ac940640f89f07d8ce16bed0c20627','rcolomer3@gmail.com',0,'user','src/TPV/Img/empleado.png',13,1300,800),('ploloooo','ldadad','95451561C',42,'699625369','6-5-1973','17-5-1998','351IG','81dc9bdb52d04dc20036dbd8313ed055','rcolomer3@gmail.com',0,'user',NULL,16,1300,800);
/*!40000 ALTER TABLE `empleadosfijos` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_insert_ef` AFTER INSERT ON `empleadosfijos` FOR EACH
ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_hist_update_ef` AFTER UPDATE ON `empleadosfijos` FOR EACH
ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_hist_delete_ef` AFTER DELETE ON `empleadosfijos` FOR EACH
ROW BEGIN
...
--
-- Table structure for table `historial_crear_ef`
--

DROP TABLE IF EXISTS `historial_crear_ef`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historial_crear_ef` (
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `procedure_edad`(OUT `empleado_joven` INT, OUT `empleado_mayor` INT)
BEGIN
SELECT MIN(Edad),MAX(Edad) into empleado_joven, empleado_mayor FROM empleadosfijos ORDER BY Edad;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT ROUND(AVG(Edad)) into Edad_media FROM empleadosfijos;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2015-05-11 13:41:52
