...
public class JavaMail {
    ...
    private String user = "1erdaw2015@gmail.com";
    ...
    public JavaMail(String vdestino, String vcontrasenyauser, String vmensaje, String vsubject) {
        destino = vdestino;
    ...
    public String send() {
        ...
        try {
            ...
            mimebodypart1.setContent("<html><font color='#FFA500'>" + mensaje + "<u>" + contrasenyauser + "</u>,apuntala y despues borra este correo<br> Mensaje enviado " + new java.util.Date() + "</font></html>", "text/html");
